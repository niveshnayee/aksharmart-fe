...
import { FaMapMarkerAlt, FaPhone, FaEnvelope, FaQuestionCircle } from 'react-icons/fa'; // Import FontAwesome icons
            ...
            <div className="row">
                ...
                <div className="col-md-6">
                    <div className="contact-form">
                        <h2>Get in Touch!</h2>
                        <p> Need to get in touch with us? Fill out the form with your message and we will response in less than 12-hour to your question.  </p>
                        <form>
