      ...
      <div className="policy-container">
        ...
        <div className="policy-section">
          ...
          <div className="policy-content">
            <p>We collect information from you when you visit our site, register on our site, place an order, subscribe to our newsletter, or fill out a form. The types of information we may collect include:</p>
            <ul>
              <li>Personal Identification Information: Name, email address, mailing address, phone number.</li>
              <li>Payment Information: Credit card information, billing address.</li>
              <li>Technical Data: IP address, browser type, operating system, and other technical details.</li>
            </ul>
          </div>
        </div>
        ...
        <div className="policy-section">
          ...
          <div className="policy-content">
            ...
            <ul>
              <li>To process transactions and deliver products or services you have requested.</li>
        ...
        <div className="policy-section">
          ...
          <div className="policy-content">
            ...
            <ul>
              <li>Using secure servers and SSL (Secure Socket Layer) technology to encrypt sensitive information.</li>
              <li>Regularly updating our software and systems to protect against potential vulnerabilities.</li>
            </ul>
          </div>
        </div>
        ...
        <div className="policy-section">
          ...
          <div className="policy-content">
            ...
            <ul>
              ...
              <li>When we need to share information to provide a product or service you have requested.</li>
